...
# UNCOMMENT IN CASE OF A DEBUGGING EMERGENCY!
# error_reporting(-1);
# ini_set('display_errors', 'On');

// \/ "original" header
/**
* Based on PubMedAPI, Copyright (c) 2012 Asif Rahman <asiftr@gmail.com>
* However, there are some minor changes and bugfixes.
*/
// ^^
// Wrapped as Bolt extension by David Krause (enthus1ast) <david@code0.xyz>

class PubMedAPI
{
	public $retmax = 500; // Max number of results to return
	...
	public $use_cache = true; // Save JSON formatted search results to a text file if TRUE
...
if (isset($_GET['author']) && $_GET['author'] != '') {
	$term = stripslashes(urldecode($_GET['author']));
...
/**
 * PubMed extension class.
 * Fetch publications from PubMed
 *
 * @author enthus1ast <david@code0.xyz>
 */
class PubMedExtension extends SimpleExtension
{
